<template>
	<view class="pri-content" v-if="showModalData">
		<view class="modal">
			<!--  成功 -->
			<block v-if="type == 'success'">
				<view class="status-icon sa-success animate" style="display: block;">
					<span class="sa-line sa-tip animateSuccessTip"></span>
					<span class="sa-line sa-long animateSuccessLong"></span>
				
					<view class="sa-placeholder"></view>
					<view class="sa-fix"></view>
				</view>
				<h2 class="h2">成功</h2>
			</block>
			<!-- 警告 -->
			<block v-if="type == 'warning'">
				<view class="status-icon sa-warning pulseWarning" style="display: block;">
			...
			<block v-if="type == 'error'">
				<view class="status-icon sa-error animateErrorIcon" style="display: block;">
			...
			<view style="font-size:1.5vw;width: 100%;text-align: center;padding:0 1.5vh;">
				{{info}}
			</view>
			<view class="closeBtn" @click="onCloseDiv">OK</view>
		</view>
	</view>
</template>
...
<script>
	export default {
		...
		methods:{
			onCloseDiv(){
				this.$emit('update:showModalData',false)
			}
		}
	}
</script>
